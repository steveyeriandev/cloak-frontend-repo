...
function PrivacyPolicyRoute() {
  /* Displays the end-user license agreement.
    ...
    Converted docx -> html using https://document.online-convert.com/convert/docx-to-html
  ...
  */
  return (
    <Container className="my-5 p-3 bg-white border">
      ...
      <p style={{ marginBottom: "0.14in" }}>Last updated: January 05, 2021</p>
      ...
      <p style={{ marginLeft: "0.5in", marginBottom: "0.14in" }}>
        ...
        Agreement) refers to Rad How To School.
      </p>
      <p style={{ marginLeft: "0.5in", marginBottom: "0.14in" }}>
      ...
      <p style={{ marginLeft: "0.5in", marginBottom: "0.14in" }}>
        <b>Do Not Track </b>
        (DNT) is a concept that has been promoted by US regulatory authorities,
      ...
      <ul>
        <li>
          <p style={{ marginBottom: "0.14in" }}>Google</p>
        </li>
        <li>
          <p style={{ marginBottom: "0.14in" }}>Facebook</p>
        </li>
        <li>
          <p style={{ marginBottom: "0.14in" }}>Twitter</p>
        </li>
      </ul>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <h2 className="western">Email Marketing</h2>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <h2 className="western">Payments</h2>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <h2 className="western">Your Rights under the GDPR</h2>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <h2 className="western">Categories of Personal Information Collected</h2>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <h2 className="western">Sources of Personal Information</h2>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <ul>
        ...
        <li>
          <p style={{ marginBottom: "0.14in" }}>
            <b>From Service Providers</b>. For example, third-party vendors for
      ...
      <ul>
        <li>
          <p style={{ marginBottom: "0.14in" }}>Category A: Identifiers</p>
        </li>
        <li>
          <p style={{ marginBottom: "0.14in" }}>
            Category B: Personal information categories listed in the California
      ...
      <h2 className="western">Sale of Personal Information</h2>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <h2 className="western">Share of Personal Information</h2>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <ul>
        <li>
          <p style={{ marginBottom: "0.14in" }}>Service Providers</p>
        </li>
        <li>
          <p style={{ marginBottom: "0.14in" }}>Payment processors</p>
        </li>
        <li>
          <p style={{ marginBottom: "0.14in" }}>Our affiliates</p>
        </li>
        <li>
          <p style={{ marginBottom: "0.14in" }}>Our business partners</p>
        </li>
        <li>
          <p style={{ marginBottom: "0.14in" }}>
      ...
      <h2 className="western">Your Rights under the CCPA</h2>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <h2 className="western">Exercising Your CCPA Data Protection Rights</h2>
      <p style={{ marginBottom: "0.14in" }}>
      ...
      <p style={{ marginBottom: "0.14in" }}>Your request to Us must:</p>
      <ul>
        <li>
          <p style={{ marginBottom: "0.14in" }}>
      ...
      <h2 className="western">Do Not Sell My Personal Information</h2>
      <p style={{ marginBottom: "0.14in" }}>
